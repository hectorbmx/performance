    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold">Editar Plan</h1>
            ...
            <form method="POST"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300">{{ old('description', $plan->description) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="billing_cycle_days"
                               value="{{ old('billing_cycle_days', $plan->billing_cycle_days) }}"
                               class="mt-1 block w-full rounded-md border-gray-300"
