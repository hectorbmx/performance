<x-app-layout>
    <div class="max-w-3xl mx-auto px-4 py-6">
        ...
        <form action="{{ route('coach.config.goals.store') }}" method="POST" class="mt-6">
            @csrf
            ...
            <div class="rounded-2xl border bg-white p-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Ejemplo: Strength, Cardio,Technique,Mobility ,Mixed.</p>
